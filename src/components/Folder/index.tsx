...
const Folder: React.FC<FolderProps> = ({
  ...
  const folderColor = isChecked ? checkedColor : color;
  ...
  return (
    <div style={scaleStyle} className={className}>
      ...
      {selection && (
        <div
          className="left-0 flex justify-center items-center top-[-8px] absolute w-full h-[calc(100%+8px)] pt-[8px] z-40 cursor-pointer"
          onClick={(e) => {
            e.stopPropagation();
            onCheckChange?.();
          }}
