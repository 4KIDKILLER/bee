...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  return (
    <div
      className={`sm-scope z-40 transition-colors duration-300 ${open ? "pointer-events-auto bg-black/40" : "pointer-events-none bg-transparent"} ${isFixed ? "fixed top-0 left-0 w-screen h-screen overflow-hidden" : "w-full h-full"}`}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        >
          ...
          >
            <span
              ref={textWrapRef}
              className="sm-toggle-textWrap relative inline-block h-[1em] overflow-hidden whitespace-nowrapw-(--sm-toggle-width,auto) min-w-(--sm-toggle-width,auto)"
              aria-hidden="true"
            >
              <span
                ref={textInnerRef}
